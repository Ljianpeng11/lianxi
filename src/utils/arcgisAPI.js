define(function () {
    ...
    instance.initSuperRainSewageMapLayer = function (view) {
        var tileInfo = new instance.TileInfo({
            "dpi": 96,
            "rows": 256,
            "cols": 256,
    ...
    instance.initSuperHighWaterLineMapLayer = function (view) {
            ...
            var tiledVectorLayer = new instance.WebTileLayer({
                ...
                urlTemplate: "http://11.0.204.11:8090/iserver/services/map-overWaterLine/wmts-china/problem_Project%40superMapOverWater/default/ChinaPublicServices_problem_Project@superMapOverWater/{level}/{row}/{col}.png",
                copyright: "",
                spatialReference: spatialReference,
                fullExtent: fullExtent,
                tileInfo: tileInfo,
