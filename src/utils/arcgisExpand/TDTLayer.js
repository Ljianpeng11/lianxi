    ...
    function () {
        ...
        cesc.require(
            [
                ...
                var fullExtent = new Extent(-180.0, -90.0, 180.0, 90.0, spatialReference);
                ...
                tdLayer.getTileUrl = function (level, row, col) {
