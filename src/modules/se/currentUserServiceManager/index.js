...
//此功能对应的视图（html）
var template = require('./currentUserServiceManager.html');
//用于获取token，url头部等
...
var comm = crudBase.extend({
        ...
        this.containerMain = new container({
            ...
            methods: {
                ...
                initForm: function () {
                    ...
                    serviceHelper.getJson(serviceHelper.getBasicPath() + "/sysUser/getCurrentUser", formData, function (result) {
                        this.setoken = result.setoken;
                    }.bind(this));
                },
    ...
    mounted: function () {
        ...
        this.containerMain.listUrl = "/seService/getCurrentUserServiceList";
